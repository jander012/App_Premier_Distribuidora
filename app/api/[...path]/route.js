...
import { openApiSpec } from '../../../backend/src/docs/openapi.js';
import { authenticateAdmin } from '../../../backend/src/middlewares/authenticateAdmin.js';
import { requireAdminStore } from '../../../backend/src/middlewares/requireAdminStore.js';
import { authenticateClient } from '../../../backend/src/middlewares/authenticateClient.js';
import { authenticateCart } from '../../../backend/src/middlewares/authenticateCart.js';
import { requireInternalApiKey } from '../../../backend/src/middlewares/requireInternalApiKey.js';
import { requireSuperAdmin } from '../../../backend/src/middlewares/requireSuperAdmin.js';
import * as menuController from '../../../backend/src/controllers/menuController.js';
import * as settingsController from '../../../backend/src/controllers/settingsController.js';
import * as customerController from '../../../backend/src/controllers/customerController.js';
import * as authClientController from '../../../backend/src/controllers/authClientController.js';
import * as cartController from '../../../backend/src/controllers/cartController.js';
import * as orderController from '../../../backend/src/controllers/orderController.js';
import * as paymentController from '../../../backend/src/controllers/paymentController.js';
import * as whatsappController from '../../../backend/src/controllers/whatsappController.js';
import * as adminController from '../../../backend/src/controllers/adminController.js';
import * as storeController from '../../../backend/src/controllers/storeController.js';
import * as adminDeliveryController from '../../../backend/src/controllers/adminDeliveryController.js';
import * as adminCouponController from '../../../backend/src/controllers/adminCouponController.js';
import * as adminMediaController from '../../../backend/src/controllers/adminMediaController.js';
import * as mediaFileController from '../../../backend/src/controllers/mediaFileController.js';
import * as adminPlatformController from '../../../backend/src/controllers/adminPlatformController.js';
import * as healthDbController from '../../../backend/src/controllers/healthDbController.js';
